...
function Layout() {
  ...
  return <main className="app-shell"><aside className="app-sidebar"><div className="app-brand"><span className="app-brand-mark">Z</span><h1>Z-Image</h1></div><nav className="mt-8 grid gap-1"><NavLink className={nav} to="/dashboard">Workspace</NavLink><NavLink className={nav} to="/datasets">Datasets</NavLink><NavLink className={nav} to="/jobs">Runs</NavLink><NavLink className={nav} to="/settings">Settings</NavLink></nav><div className="app-sidebar-footer"><span className="app-status-dot"/>API online</div></aside><div className="app-body"><header className="app-topbar"><span className="text-xs font-medium text-slate-500">Local session</span><div className="app-topbar-status"><span className="app-status-dot"/>Ready</div></header><section className="app-content"><Outlet /></section></div></main>
}
