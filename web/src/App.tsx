...
function Layout() {
  ...
  return <main className="app-shell"><aside className="app-sidebar"><div><p className="text-[10px] font-bold tracking-[.2em] text-cyan-300">LOCAL WORKSPACE</p><h1 className="mt-2 text-lg font-bold tracking-tight text-white">Z-Image Turbo</h1><p className="mt-1 text-xs text-slate-400">LoRA training console</p></div><nav className="mt-10 grid gap-1"><NavLink className={nav} to="/dashboard">Workspace</NavLink><NavLink className={nav} to="/datasets">Datasets</NavLink><NavLink className={nav} to="/jobs">Runs</NavLink><NavLink className={nav} to="/settings">Settings</NavLink></nav><div className="app-sidebar-footer"><span className="app-status-dot"/>Local API online</div></aside><div className="app-body"><header className="app-topbar"><div><span className="text-[10px] font-bold tracking-[.18em] text-slate-400">TRAINING STUDIO</span><p className="mt-0.5 text-xs font-medium text-slate-600">Build, monitor, and export your LoRA.</p></div><div className="app-topbar-status"><span className="app-status-dot"/>Ready</div></header><section className="app-content"><Outlet /></section></div></main>
}
